...
<body>
    ...
    <div class="row justify-content-center" style="margin: 12px">
            ...
            <div class="col-4">
            Инструменты:<br>
                <a class="btn btn-primary" href="insert_orders.php" role="button">Добавить заказ</a>
            <br>
                Таблицы:<br>
        ...
        <table class="table table-success table-striped">
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    <td><?php if($row['status_pay'] != "Оплачен"){?><a class='btn btn-outline-danger' href="src/status_pay.php?id=<?=$id?>" >Оплачен</a></td><?php }else{}?>
